...
class ApiService extends GetxService {
  ...
  Future<Response> getPublic(String uri, params) async {
    String uriWithparams = "$uri/$params";
    try {
      log("Params :$uriWithparams");
      http.Response response = await http
          .get(
            Uri.parse(uriWithparams),
          )
  ...
  Future<Response> uploadFiles(
      String uri, List<MultipartBody> multipartBody, name, phone, id) async {
    try {
